...
def create_phrase_nltk_1_features(df): 
    phrase_nltk_1_values = []
    ...
    for i in df.index:
        if df.loc[i,'Class'] > -1:
            ...
            phrase_nltk_1_values.append(value)
        else:
            phrase_nltk_1_values.append(-1)

    print('phrase_nltk_1 features created!')
    return phrase_nltk_1_values
