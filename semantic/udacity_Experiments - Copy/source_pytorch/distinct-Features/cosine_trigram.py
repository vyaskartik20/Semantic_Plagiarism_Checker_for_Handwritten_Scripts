...
# for filename in os.listdir(DATASET):
	# assignment_files.append(DATASET + '/' + filename + 't.txt')

assignment_files.append(DATASET + '/' + 'assignment_0')
assignment_files.append(DATASET + '/' + 'assignment_1')
assignment_files.append(DATASET + '/' + 'assignment_2')
	...
	for idx_1 in range(0, NUM_DOCS):
		for idx_2 in range(0, NUM_DOCS):
			if idx_1 != idx_2:
				...
				cosineSim = cosineSim * (numOfWords[idx_1] + numOfWords[idx_2] ) / (2*numOfWords[idx_1]) 
				if(cosineSim>1):
					cosineSim=1
				print ('Cosine similarity measure of document {0} from {1} gives {2} as the result'.format(idx_1, idx_2, cosineSim))
else:
	...
	for idx_1 in range(0, NUM_DOCS):
		for idx_2 in range(0, NUM_DOCS):
			if idx_1 != idx_2:
				...
				jaccardSim = jaccardSim * (numOfWords[idx_1] + numOfWords[idx_2] ) / (2*numOfWords[idx_1]) 
				print ('Jaccard similarity measure of document {0} from {1} gives {2} as the result'.format(idx_1, idx_2, jaccardSim))
