...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_dir', type=str,
                        default=os.path.dirname('D:/BTP-2/semantic/udacity_Experiments_Copy/source_pytorch/model/'))
    parser.add_argument('--data_dir', type=str,
                        default=os.path.dirname('D:/BTP-2/semantic/udacity_Experiments_Copy/source_pytorch/plagiarism_data/'))
