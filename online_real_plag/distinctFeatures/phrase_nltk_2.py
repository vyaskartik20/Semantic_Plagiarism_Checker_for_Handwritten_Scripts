...
def create_phrase_nltk_2_features(df): 
    phrase_nltk_2_values = []
    ...
    print('phrase_nltk_2 features created!')
    return phrase_nltk_2_values
    
    
# text1 = "Kartik Vyas studies at IITJ"
# text2 = "Kartik Vyas is an Undergrad student at IITJ"

# print(similarity(text1, text2, True))